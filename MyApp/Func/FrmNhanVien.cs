...
namespace XML130.Func
{
    public partial class FrmNhanVien : FrmBase
    {
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable("SELECT *, CASE a.TrangThai WHEN 0 THEN N'Bác sỹ' WHEN 1 THEN N'Kỹ thuật viên' ELSE N'Không xác định' END AS TrangThaiText FROM tblNhanVien a");
        ...
        protected override void OnEdit()
        {
            ...
            F = new FrmNhanVienDtl(dataTable, ECommand.EUpdate);
        ...
        {
            DataTable dt = null;
            F = new FrmNhanVienDtl(dt, ECommand.EAdd);
