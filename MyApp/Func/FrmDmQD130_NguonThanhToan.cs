...
{
    public partial class FrmDmQD130_NguonThanhToan : FrmBase
    {


        public FrmDmQD130_NguonThanhToan()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_NguonThanhToan"));
