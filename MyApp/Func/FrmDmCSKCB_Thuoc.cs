...
{
    public partial class FrmDmCSKCB_Thuoc : FrmBase
    {


        public FrmDmCSKCB_Thuoc()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmCSKCB_Thuoc"));
