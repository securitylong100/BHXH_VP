...
{
    public partial class FrmDmQD130_MaPhamViThanhToan : FrmBase
    {


        public FrmDmQD130_MaPhamViThanhToan()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_MaPhamViThanhToan"));
