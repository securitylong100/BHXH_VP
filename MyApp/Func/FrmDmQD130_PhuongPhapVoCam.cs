...
{
    public partial class FrmDmQD130_PhuongPhapVoCam : FrmBase
    {


        public FrmDmQD130_PhuongPhapVoCam()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_PhuongPhapVoCam"));
