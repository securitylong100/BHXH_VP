...
{
    public partial class FrmDmQD130_KetQuaDieuTri : FrmBase
    {


        public FrmDmQD130_KetQuaDieuTri()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_KetQuaDieuTri"));
