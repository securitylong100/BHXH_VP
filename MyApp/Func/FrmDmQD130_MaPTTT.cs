...
{
    public partial class FrmDmQD130_MaPTTT : FrmBase
    {


        public FrmDmQD130_MaPTTT()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_MaPTTT"));
