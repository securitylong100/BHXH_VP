...
{
    public partial class FrmDmQD130_NgheNghiep : FrmBase
    {


        public FrmDmQD130_NgheNghiep()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_NgheNghiep"));
