...
{
    public partial class FrmDmQD130_MaLoaiRaVien : FrmBase
    {


        public FrmDmQD130_MaLoaiRaVien()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_MaLoaiRaVien"));
