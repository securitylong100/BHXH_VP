...
{
    public partial class FrmDmQD130_MaTaiNan : FrmBase
    {


        public FrmDmQD130_MaTaiNan()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_MaTaiNan"));
