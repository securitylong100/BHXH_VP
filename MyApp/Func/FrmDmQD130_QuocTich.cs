...
{
    public partial class FrmDmQD130_QuocTich : FrmBase
    {


        public FrmDmQD130_QuocTich()
        {
            InitializeComponent();
        ...
        protected override void OnInit()
        {
            try
            {
                DataTable dataTable = SQLHelper.ExecuteDataTable(string.Format("SELECT * FROM tblDmQD130_QuocTich"));
